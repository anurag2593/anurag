<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PassportApplicationForm1.aspx.cs" Inherits="Data_Display_Application_PassportApplicationForm1" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Type_of_Application" 
                    HeaderText="Type_of_Application" SortExpression="Type_of_Application" />
                <asp:BoundField DataField="Passport_Booklet" HeaderText="Passport_Booklet" 
                ...
                <asp:BoundField DataField="Previous_Surname" HeaderText="Previous_Surname" 
                    SortExpression="Previous_Surname" />
                ...
                <asp:BoundField DataField="Citizenship_India_by" 
                    HeaderText="Citizenship_India_by" SortExpression="Citizenship_India_by" />
                ...
                <asp:BoundField DataField="Employment_Type" HeaderText="Employment_Type" 
                    SortExpression="Employment_Type" />
                <asp:BoundField DataField="Organisation_Name" HeaderText="Organisation_Name" 
                    SortExpression="Organisation_Name" />
                <asp:BoundField DataField="Parent_government_servant" 
                    HeaderText="Parent_government_servant" 
                    SortExpression="Parent_government_servant" />
                <asp:BoundField DataField="Educational_Qualification" 
                    HeaderText="Educational_Qualification" 
                ...
                <asp:BoundField DataField="Visible_DistMark" HeaderText="Visible_DistMark" 
                    SortExpression="Visible_DistMark" />
                <asp:BoundField DataField="Aadhaar_Number" HeaderText="Aadhaar_Number" 
